    ...
    {show.dateTime[date].map((item) => (
      ...
      <div className='relative flex-1 flex flex-col items-center max-md:mt-16'>
        ...
        <p className='text-gray-400 text-sm mb-6'>Screen Side</p>
          ...
          <button onClick={() => naviagte('/my-bookings')}   className="flex items-center gap-1 mt-20 px-10 py-3 text-sm bg-primary hover:bg-primary-dull transition rounded-full font-medium cursor-pointer active:scale-95"
>Proceed to checkout
